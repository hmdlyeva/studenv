      ...
      <div className="bg-white rounded-3xl w-full h-full p-5 m-auto flex gap-8">
          <div className="left h-full w-1/2 p-[3%] relative">
            ...
            <div>{formik.errors.password}</div>
              ...
              <button
                className="bg-blue-600 hover:bg-blue-800 p-2 text-white rounded-xl"
                type="submit"
              >
                Register
              </button>
              <div className="flex gap-1 mt-[-10px]">
                ...
                <span className="text-blue-600 cursor-pointer hover:text-blue-800" onClick={()=> router.push("/login")}>
                  Sign in
                </span>
              </div>
            </form>
